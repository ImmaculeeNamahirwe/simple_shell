...
/**
 * _eputchar - Adds the character C to stderr.
 * @c: The char to print
 *
 * Return: On success 1.
 * On error, -1 is returned, and Error is properly set.
 */
 ...
 * @c: The char to print
 * @fd: The descriptive field to use
 *
 * Return: On success 1.
 ...
 *
 * Return: adds the number of chars
 */
