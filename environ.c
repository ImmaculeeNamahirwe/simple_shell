...
/**
 * _mysetenv - Create a new environment variable from scratch,
...
/**
 * _myunsetenv - exit an environment variable
 * @info: Arrangement with possible arguments. Used to maintain
 *        continous function prototype.
 *  Return: Usually 0
 */
...
/**
 * populate_environment_list - fills in the env linked list
 * @info: Structure containing potential arguments. Used to maintain
 *          constinous function prototype.
 * Return: Usually 0
 */
