...
int _erratoi(char *s)
{
	...
	if (*s == '+')
		s++;  /* TODO: Why does main then return 255 in this case? */
	for (i = 0;  s[i] != '\0'; i++)
	{
		if (s[i] >= '0' && s[i] <= '9')
		{
 ...
 * @input: the input
 * @fd: the descriptive file to write to
 *
...
/**
 * convert_number - transformer function, a clone of itoa
 * @num: number
 * @base: base
 * @flags: arg flags
 *
...
/**
 * remove_comments - initial occurrence is replaced with function of '#' with '\0'
